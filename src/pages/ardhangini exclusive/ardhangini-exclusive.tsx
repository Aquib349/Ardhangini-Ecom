...
const ArdhanginiExclusive: React.FC = () => {
  const { ardhanginiExclusive, addItemWishlist, addItemCart } = useGlobal();
  ...
  const totalPages = Math.ceil(ardhanginiExclusive.length / itemsPerPage);
  const startIndex = (currentPage - 1) * itemsPerPage;
  const currentProducts = ardhanginiExclusive.slice(
    startIndex,
